/*//GEN-FIRST:event_dishListValueChanged
 * To change this template, choose Tools | Templates//GEN-LAST:event_dishListValueChanged
...
public class CookFrame extends javax.swing.JFrame implements GUIUpdater{
    ...
    private void dishListValueChanged(javax.swing.event.ListSelectionEvent evt) {                                      
        DishOrder selectedDish = (DishOrder)dishList.getSelectedValue();
    ...
    private void btnOrderDoneActionPerformed(java.awt.event.ActionEvent evt) {                                             
        FetchedOrder selectedOrder = (FetchedOrder)orderList.getSelectedValue();
        if (selectedOrder != null){
            try {
    ...
    private void btnLastOrderActionPerformed(java.awt.event.ActionEvent evt) {                                             
        if (lastMade != null){
            try {
